...
export const LawyerReg = () => {
  ...
  const users = [
    { name: "Varsha", ph_no: 12345 },
    { name: "bhuvana", ph_no: 67890 },
  ];
  ...
  const handleClick = () => {
    ...
    const isValidUser = users.some(
      ...
      console.log(users,"wjdhuu")
    if (isValidUser) {
      navigate("/verificationLawyer");
    } else {
        ...
        <div className="col-12 col-md-6 col-lg-4 mt-3 mb-5">
          ...
          <div>
            <form>
              ...
              <label htmlFor="phoneNumber" className="form-label">ID Number</label>
                <input
                  type="text"
                  className="form-control"
                  id="phoneNumber"
