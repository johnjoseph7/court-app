      ...
      <div className="row mt-5 mb-5 justify-content-center align-item-center">
        <div className="col-12 col-md-6 col-lg-4 mt-3 mb-5">
          <div className="text-center">
            ...
            <div className="mt-3">
              <button className="btn btn-danger btn-fixed-width p-2" onClick={() => handleClick("LawyerReg")}>
                Lawyer registration
              </button>
            </div>
            <div className="mt-3 mb-5">
              <button className="btn btn-danger btn-fixed-width p-2" onClick={() => handleClick("ClientReg")}>
                Client registration
              </button>
            </div>
            ...
            <div className="mb-5">
              ...
              <a onClick={() => handleClick()} href="/createLogin">
                Login
              </a>
            </div>
