...
export const SideBar = ({ handleElementClick, active, setActive }) => {
  ...
  const menuItems = [
    ...
    { title: "My Case", icon: "fas fa-briefcase" },
            ...
            {menuItems.map((item, index) => (
              <li
                ...
                onClick={() => {
                  ...
                  if (item.title === "ePayments") {
                    navigate("/paymentPage");
                  }
                  else if (item.title === "Help") {
                    navigate("/Help");
                  } 
                  else if (item.title === "India Code") {
                    navigate ('/IndiaCode')
                  }
                  else if (item.title === "ePrivacy Policy") {
                    navigate ('/IndiaCode')
                  }
                  else if(item.title === "Disclaimer"){
                    navigate ('/Disclaimer')
                  }
                  else if (item.title === "eCommitee") {
                    navigate ('/Ecommittee')
                  }
                  else if (item.title === "Home") {
                    navigate("/clientDashboard");
                  }
                  else if (item.title === "My Case") {
                    navigate("/clientDashboard");
                  }
                }}
              >
